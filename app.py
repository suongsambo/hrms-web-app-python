...
# @app.route('/leave_hours/crd/add/<string:branch>', methods=['GET', 'POST'])
# @login_required
...
#     return render_template('/leaves/add_leave_hours_crd.html', employees=employees, users=users, branch=branch)
